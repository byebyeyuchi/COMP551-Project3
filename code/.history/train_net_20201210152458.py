...
parser.add_argument('-net', type=str, default='resnet50' , help='net type')  #在这定义网络，default里设置默认网络
#parser.add_argument('-gpu', type=bool, default=True, help='use gpu or not')  #选择是否使用GPU 
parser.add_argument('-bz', type=int, default=4, help='batch size')          #选择Batchsize
parser.add_argument('-epoch', type=int, default=5, help='epoch')        #指定Epoch训练轮数
parser.add_argument('-w', type=int, default=4, help='num_workers')
...
optimizer_conv = optim.Adam( model_conv.parameters(), lr=args.lr, betas=(0.5, 0.999))
