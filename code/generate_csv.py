...
parser.add_argument('-net', type=str, default='resnet18' , help='net type')  # define your network here
parser.add_argument('-output', type=str, default='resnet18', help='checkpoint dir') 
